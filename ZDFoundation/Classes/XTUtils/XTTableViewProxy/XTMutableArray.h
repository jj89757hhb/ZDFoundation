...
@interface XTMutableArray<__covariant ObjectType> : NSMutableArray <XTModelID>
/**
 初始化方法
 @param identity 标识符
 */
...
/**
 ...
 @return nil：表示没有找到对象
 */
- (nullable NSArray<ObjectType<XTModelID>> *)objectsForID:(nonnull id)identity;
...
/**
 ...
 @return nil：表示没有找到对象
 */
- (nullable ObjectType<XTModelID>)firstObjectForID:(nonnull id)identity;
...
@interface XTMutableArray (ObjectSubscripting)
/**
 根据标识符查找对象
 @param key 标识符
...
@interface NSArray (XTMutaleArray)
- (nonnull XTMutableArray *)XTMutableArray;
@end
