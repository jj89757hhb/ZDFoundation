...
- (void)setXt_left:(CGFloat)zd_left {
    self.zd_x = zd_left;
}
...
- (void)setXt_right:(CGFloat)zd_right {
    CGRect frame = self.frame;
...
- (void)setXt_bottom:(CGFloat)zd_bottom {
    CGRect frame = self.frame;
...
- (void)setXt_width:(CGFloat)zd_width {
    CGRect frame = self.frame;
...
- (void)setXt_height:(CGFloat)zd_height {
    CGRect frame = self.frame;
...
- (void)setXt_centerX:(CGFloat)zd_centerX {
...
- (void)setXt_centerY:(CGFloat)zd_centerY {
...
- (void)setXt_origin:(CGPoint)zd_origin {
    CGRect frame = self.frame;
...
- (void)setXt_size:(CGSize)zd_size {
    CGRect frame = self.frame;
    frame.size = zd_size;
    self.frame = frame;
}
